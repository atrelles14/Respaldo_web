        ...
        <div class="personal_info">
            ...
            <table border="0.5">
                ...
                <tr>
                    ...
                    <td><a href='../VIEW_USERS/editar_perfil.php?campo=Usu_user&id=<?php echo $id_usuario; ?>'>Editar</a></td>
                </tr>
                <tr>
                    <td>Password</td>
                    <td><?php echo $datos_usuario['Usu_password']; ?></td>
                    <!-- Enlaces para editar los datos si es necesario -->
                    <td><a href='../VIEW_USERS/editar_perfil.php?campo=Usu_password&id=<?php echo $id_usuario; ?>'>Editar</a></td>
                </tr>
                <tr>
                    <td>Correo</td>
                    <td><?php echo $datos_usuario['Usu_email']; ?></td>
                    <!-- Enlaces para editar los datos si es necesario -->
                    <td><a href='../VIEW_USERS/editar_perfil.php?campo=Usu_email&id=<?php echo $id_usuario; ?>'>Editar</a></td>
                </tr>
                <tr>
                    <td>Nombre</td>
                    <td><?php echo $datos_usuario['Usu_nombre']; ?></td>
                    <!-- Enlaces para editar los datos si es necesario -->
                    <td><a href='../VIEW_USERS/editar_perfil.php?campo=Usu_nombre&id=<?php echo $id_usuario; ?>'>Editar</a></td>
                </tr>
                <tr>
                    <td>Apellido</td>
                    <td><?php echo $datos_usuario['Usu_apellido']; ?></td>
                    <!-- Enlaces para editar los datos si es necesario -->
                    <td><a href='../VIEW_USERS/editar_perfil.php?campo=Usu_apellido&id=<?php echo $id_usuario; ?>'>Editar</a></td>
                </tr>
                <tr>
                    <td>Fecha de Nacimiento</td>
                    <td><?php echo $datos_usuario['Usu_fechacumple']; ?></td>
                    <!-- Enlaces para editar los datos si es necesario -->
                    <td><a href='../VIEW_USERS/editar_perfil.php?campo=Usu_fechacumple&id=<?php echo $id_usuario; ?>'>Editar</a></td>
                </tr>
            </table>
        </div>

    </header>
    <a href="../VIEW_USERS/index_users.php">Volver a Home</a>
</body>
</html>
<?php
} else {
