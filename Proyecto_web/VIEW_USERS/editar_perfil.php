...
if (isset($_GET['id']) && isset($_GET['campo'])) {
    ...
    if ($campo_editar === 'Usu_user') {
        ?>
            ...
            ?>
            <form action="../VIEW_USERS../EDITAR_PERFIL/editar_user.php?id=<?php echo $id_usuario ?>" method="POST">
                <label for="nuevo_usuario">Nombre de usuario nuevo</label>
                <input type="text" name="nuevo_usuario" required>
                <input type="submit" value="Guardar">
            </form>
            <a href="perfil_user.php">Volver</a>
        <?php
        ...
        ?>
            ...
            ?>
            <form action="../VIEW_USERS../EDITAR_PERFIL/editar_password.php?id=<?php echo $id_usuario ?>" method="POST">
        ...
        ?>
        <form action="../VIEW_USERS../EDITAR_PERFIL/editar_email.php?id=<?php echo $id_usuario ?>" method="POST">
        ...
        ?>
        <form action="../VIEW_USERS../EDITAR_PERFIL/editar_nombre.php?id=<?php echo $id_usuario ?>" method="POST">
        ...
        ?>
        <form action="../VIEW_USERS../EDITAR_PERFIL/editar_apellido.php?id=<?php echo $id_usuario ?>" method="POST">
        ...
        ?>
        <form action="../VIEW_USERS../EDITAR_PERFIL/editar_fecha.php?id=<?php echo $id_usuario ?>" method="POST">
